            ...
            <form action="{{ route('suboffer.update', $subOffer->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-header bg-none fw-bold row">
                        ...
                        <div class="col-md-6 text-align-end">
                            @if (
                                ...
                                <a href="javascript:void(0)" class="btn btn-warning me-2 generate-button show_btn mb-2 text-white"
                ...
                <div class="row">
                    <div class="col-md-12 text-end ">
                        <button type="submit" class="btn btn-primary">{{ __('Update Sub Offer') }}</button>
                    </div>
                </div>
            </form>
        </div>

                ...
                <div class="card mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-end mb-3">
                            <button type="submit" class="btn btn-primary mr-3">{{ __('Add Sub Offer') }}</button>
                        </div>
                    </div>
                </div>
                {{-- <div class="card mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('Headline') }}<span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" name="headline" placeholder="Enter Headline" rows="3"
                                        id="sub_headline-{{ $campaignAllDetails->id }}"></textarea>
                                    @error('headline')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('Primary Text') }}<span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" name="primary_text" placeholder="Enter Primary Text" rows="3"
                                        id="sub_primary-text-{{ $campaignAllDetails->id }}"></textarea>
                                    @error('primary_text')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="description" placeholder="Enter Description" rows="3"
                                        id="sub_description-{{ $campaignAllDetails->id }}"></textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: `{{ route('suboffer.count', ['id' => $campaignAllDetails->id]) }}`,
                method: 'GET',
                success: function(response) {
        ...
        const baseUrl = @json(route('generate-headlines-manual-suboffer', ['id' => $campaignAllDetails->id]));

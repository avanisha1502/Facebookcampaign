            ...
            <div class="col-xl-9">
                ...
                <div id="general" class="mb-5">
                    <div class="list-group-item d-flex align-items-center">
                        <div class="flex-fill">
                            <h4><i class="far fa-user fa-fw"></i> {{ __('Campaign Name Settings') }}</h4>
                            <p>View and update your general account information and settings.</p>
                        </div>
                        @if ($groupsWithoutSettings->isNotEmpty())
                            <div class="w-120px">
                                <a class="btn btn-theme" href="#" data-size="md" data-ajax-popup="true"
                                    data-url="{{ route('add-campaign-name') }}"
                                    data-title="{{ __('Add New Name Setting') }}">
                                    <i class="fa fa-plus-circle fa-fw me-1"></i> {{ __('Add Name') }}</a>
                            </div>
                        @endif
                    </div>
                    <div class="card">
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <div>
                                    <button class="btn btn-default w-150px"> {{ $setting->value }}</button>
                                </div>
                            </div>
                            @empty
                                <div class="list-group-item d-flex align-items-center">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item d-flex align-items-center">
                                <div class="flex-fill">
                                    <div>Reminders</div>
                                    <div class="text-gray-500 d-flex align-items-center">
                                        <i class="fa fa-circle fs-8px fa-fw text-success me-1"></i> Enabled (Push, Email,
                                        SMS)
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="flex-fill">
                                    ...
                                    <div class="text-gray-500 d-block d-xl-flex align-items-center">
                                        <div class="d-flex align-items-center"><i
                                                class="fa fa-circle fs-8px fa-fw text-muted me-1"></i> Disabled</div>
                                        <span
                ...
                <nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
                    <nav class="nav">
                        <a class="nav-link" href="#general"
                            data-bs-toggle="scroll-to">{{ __('Campaign Name Settings') }}</a>

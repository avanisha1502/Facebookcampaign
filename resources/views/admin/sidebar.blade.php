<div class="menu">
    ...
    <div
        class="menu-item {{ request()->is('ads-library') ? ' active' : '' }}">
        <a href="{{ route('ads_library.index') }}" class="menu-link">
            {{-- <i class="fa-solid fa-megaphone"></i> --}}
            <span class="menu-icon"><i class="fa fa-lg fa-fw me-2 fa-book"></i></span>

<div class="menu">
    ...
    <div class="menu-item {{ (\Request::route()->getName()=='googleadskeyword.index' || \Request::route()->getName()=='googleadskeyword.filter' || \Request::route()->getName()=='googleadskeyword.show') ? ' active' : '' }}">
    ...
    <div class="menu-item {{ (\Request::route()->getName()=='index-campaign' || \Request::route()->getName()=='create-campaign' || \Request::route()->getName()=='edit-campaign' || \Request::route()->getName()=='campaign.filter' || \Request::route()->getName()=='generate-headlines-show' || \Request::route()->getName() == 'generate-imageUpload') ? ' active' : '' }}">
    ...
    <div class="menu-item {{ (\Request::route()->getName()=='countries.index' || \Request::route()->getName()=='create.countries' || \Request::route()->getName()=='edit.countries' || \Request::route()->getName()=='countries.filter') ? ' active' : '' }}">
    ...
    <div class="menu-item {{ (\Request::route()->getName()=='campaign.show' || \Request::route()->getName()==  'ads-filter') ? ' active' : '' }}">
